...
public class ArmGenerator : MonoBehaviour
{
    ...
    void CreateArmHighLevel()
    {
        ...
        elbow_left.transform.localScale = new Vector3(1f, 0.5f, 1f); // Adjust local position
        ...
        shoulder_right.transform.localRotation = Quaternion.Euler(0f, 0f, 0f); // Adjust local position
        ...
        elbow_right.transform.localRotation = Quaternion.Euler(0f, 0f, 0f); // Adjust local position
        elbow_right.transform.localPosition = new Vector3(0, -4.2f, 0); // Adjust local position
        elbow_right.transform.localScale    = new Vector3(1f, 0.5f, 1f); // Adjust local position
        ...
        //shoulder left
        arm_left.transform.GetChild(0).transform.localRotation = Quaternion.Euler(0, 0, 0);
        //shoulder left
        arm_right.transform.GetChild(0).transform.localRotation = Quaternion.Euler(0, 0, 0);
    }
